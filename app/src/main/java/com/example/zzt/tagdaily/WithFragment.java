...
public class WithFragment extends Activity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.folder_fragment_container) != null
            ...
            fragmentTransaction
                    .add(R.id.folder_fragment_container, categoryFragment);
            fragmentTransaction
    ...
    @Override
    public void folderFragmentClick(String id) {
        Log.d(thisClass, id + " is choose");

        DetailFileFragment fileFragment = (DetailFileFragment)
                getFragmentManager().findFragmentById(R.id.file_fragment_container);
        ArrayList files = new ArrayList();

        fileFragment.updateListView(files);
    }

    @Override
    public void detailFragmentClick(String id) {
        Log.d(thisClass, id + " is choose");
